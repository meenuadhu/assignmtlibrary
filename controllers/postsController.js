...
const postForm = (req, res) => {
    res.render('createPost', { title: 'Create new book', login: true, errors: [], input_title: '',input_author:'', body: '' })
}
...
const storePost = (req, res) => {
    ...
    form.parse(req, (err, fields, files) => {
        ...
        if (errors.length !== 0) {
            res.render("createPost", { title: 'Create new book', login: true, errors, input_title: title,input_author: author, body })
        } else {
                                ...
                                if (!err) {
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            if (result) {
                                                req.flash('success', "Your book has been added successfully")
...
const posts = async (req, res) => {
    ...
    res.render("Posts", { title: 'Books', login: true, posts: allPosts, formate: dateFormat, count, perPage, currentPage })
}
